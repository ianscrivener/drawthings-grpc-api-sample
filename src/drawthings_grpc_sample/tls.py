"""TLS helpers for Draw Things gRPC clients."""
...
DRAW_THINGS_ROOT_CA_PEM = b"""-----BEGIN CERTIFICATE-----
...
def _load_root_certificates(ca_cert_file: str | None) -> bytes:
    if ca_cert_file:
        return Path(ca_cert_file).expanduser().read_bytes()
    return DRAW_THINGS_ROOT_CA_PEM
